# ===========================================================
#    Copied from the original source code of Ursina Prefab
#
# Modified by: Kan-à-Pesh
# Description: Added a max and min value for the camera rotation
#
# ===========================================================
...
class FirstPersonController(Entity):
    ...
    def update(self):
        ...
        self.camera_pivot.rotation_x= clamp(self.camera_pivot.rotation_x, self.min_cam_x, self.max_cam_x)
